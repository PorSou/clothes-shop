    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center flex-grow px-4 mt-20 text-center">
          ...
          <Link
            to="/shop"
            className="px-6 py-3 text-white transition bg-gray-800 rounded-lg hover:bg-gray-700"
          >
            Discover Products
          </Link>
        </div>
      ...
      <div className="flex-grow w-full max-w-6xl px-6 py-12 mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="px-4 py-2 text-sm text-white transition bg-gray-800 rounded hover:bg-gray-700"
          >
            Clear All
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item) => (
            <div
              key={item.id}
              className={`p-4 rounded-lg shadow transition-all hover:shadow-lg ${
                theme === "dark"
            ...
            >
              ...
              <button
                ...
                className="w-full px-4 py-2 mt-3 text-sm text-white transition bg-gray-800 rounded hover:bg-gray-700"
              >
                Remove
              </button>
            </div>
